...
// Array.prototype.sort()
    ...
    // const inventorsByBday = inventors.sort((inventor1,inventor2) => {
    ...
    // });
    // console.table(inventorsByBday);
     // Array.prototype.reduce()
    // 4. How many years did all the inventors live?
    // const yearsLived = inventors.reduce((sum,inventor)=>{ 
    //   return sum+(inventor.passed-inventor.year)
    // },0);
    // console.log(yearsLived);

     // 5. Sort the inventors by years lived
     // const lifeSpan = inventors.sort((inventor1,inventor2)=>{
    ...
    // const boulevardCategory = document.querySelector('.mw-category');
    // const links = Array.from(boulevardCategory.querySelectorAll('a'));
    // const de = links.filter(link=>link.textContent.includes(' de '));
    // console.log(links);

    // 7. sort Exercise
    // Sort the people alphabetically by last name
    // const peopleByLastName = people.sort((person1,person2)=>{
    //   return person1.split(',')[1] > person2.split(',')[1]?1:-1;
    // });
